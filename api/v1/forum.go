...
// @Param        x-token  header    string           true  "token"
// @Param        id       path      int              true  "帖子ID"
// @Param        data     body      api.UpdatePostQ  true  "帖子所属板块，帖子标题，帖子内容"
// @Success      200      {object}  api.CommonA      "是否成功，返回信息"
...
// @Param        x-token  header    string        true  "token"
// @Param        id       path      int           true  "帖子ID"
// @Success      200      {object}  api.GetPostA  "创建者ID，创建者名字，创建者头像路径，标题，内容，最后更新时间"
...
// @Success      200      {object}  api.GetAllPostA  "是否成功，返回信息"
...
// @Param        x-token  header    string              true  "token"
// @Param        id       path      int                 true  "帖子ID"
// @Param        data     body      api.CreateCommentQ  true  "回复的评论ID，用户ID，评论内容"
// @Success      200      {object}  api.CommonA         "是否成功，返回信息"
...
// @Param        data     body      api.UpdateCommentQ  true  "评论内容"
// @Success      200      {object}  api.CommonA         "是否成功，返回信息"
...
// @Param        x-token  header    string       true  "token"
// @Param        id       path      int          true  "帖子ID"
// @Success      200      {object}  api.GetCommentA  "是否成功，返回信息，评论列表"
